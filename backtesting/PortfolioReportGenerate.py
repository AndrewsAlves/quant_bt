...
finstg920 = pd.read_csv(backtestReportTradesPath  + 'fc92039a_finNifty 9 20 25 SL Classic.csv')
finstg11 = pd.read_csv(backtestReportTradesPath  + '0cfdadad_finNifty 11 15 25 SL Classic.csv')
...
#portforlioDic['FINNIFTY_9:20'] = pr.getStrategyDic('FINNIFTY_9:20', 'FINNIFTY', finstg920, 1000000 )
portforlioDic['FINNIFTY_11:15'] = pr.getStrategyDic('FINNIFTY_11:15', 'FINNIFTY', finstg11, 1000000 )
#portforlioDic['FINNIFTY_1:15'] = pr.getStrategyDic('FINNIFTY_1:15', 'FINNIFTY', finstg1pm, 1000000 )

#%%

portfolioBuilder = pr.PortfolioReportBuilder(portforlioDic, 1000000, onlyExpiry = True, year=2019)
